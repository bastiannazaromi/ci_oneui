        ...
        <div class="col-sm-12">
            <div class="block block-rounded">
                <div class="block-header bg-dark">
                    <h3 class="block-title text-white">Status Mahasiswa</h3>
                        ...
                        <table class="table table-bordered table-striped table-vcenter">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-size-sm"><?= $hasil->id_stat_mhs; ?></td>
                                    <td class="font-size-sm"><?= $hasil->created_at; ?></td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-warning edit_btn"
                                            data-toggle="modal" data-target="#modal-edit"
                                            data-id="<?= enkrip($hasil->id); ?>" data-kode="<?= $hasil->id_stat_mhs; ?>" data-nama="<?= $hasil->nama_status; ?>"
                                            title="Edit">
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title text-center">Status Mahasiswa</h3>
                    <div class="block-options">
                ...
                <form action="<?= base_url('admin/statusmhs/add'); ?>" method="post">
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group">
                            <label for="nama_status">Kode Status</label>
                            <input type="text" class="form-control" name="kode_status" required autocomplete="off">
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <form action="<?= base_url('admin/statusmhs/edit'); ?>" method="post">
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group">
                            <label for="nama_status">Kode Status</label>
                            <input type="text" class="form-control" name="kode_status" id="kode" required
                                autocomplete="off">
                        </div>
                    </div>
                    <div class="block-content block-content-full text-right border-top">
