        ...
        <div class="col-sm-12">
            <div class="block block-rounded">
                <div class="block-header bg-dark">
                    <h3 class="block-title text-white">Pengaturan Setting Mode dan Bobot Nilai</h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-size-sm">
                                        <?= ($hasil->mode == 1) ? 'HURUF' : 'RANGE ANGKA'; ?>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-alt-primary edit_btn"
                                                ...
                                                data-mode="<?= enkrip($hasil->mode); ?>" title="Edit">
                                                <i class="fa fa-fw fa-pencil-alt"></i>
                                            </button>
                                            <button type="button"
                                                data-href="<?= base_url('admin/setbobotnilai/delete/') . enkrip($hasil->id); ?>"
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title text-center">Setting Bobot Nilai</h3>
                    <div class="block-options">
                ...
                <form action="<?= base_url('admin/setbobotnilai/add'); ?>" method="post">
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="mode" style="width: 100%;"
                                data-placeholder="Choose one..">
                                <option></option>
                                <option value="<?= enkrip(1); ?>">HURUF</option>
                                <option value="<?= enkrip(2); ?>">RANGE ANGKA</option>
                            </select>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <form action="<?= base_url('admin/setbobotnilai/edit'); ?>" method="post">
                    <div class="block-content font-size-sm">
