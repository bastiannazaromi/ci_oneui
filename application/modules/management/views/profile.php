...
<div class="bg-image" style="background-image: url('<?php echo $one->assets_folder; ?>/media/photos/photo8@2x.jpg');">
    <div class="bg-black-75">
        <div class="content content-full text-center">
            ...
            <a class="btn btn-light" href="<?= base_url('management'); ?>">
...
<div class="content content-boxed">
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content">
            <form action="<?= base_url('management/profile/updateFoto'); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content">
            <form action="<?= base_url('management/profile/updatePass'); ?>" method="POST">
                <input type="hidden" class="csrf_tokem" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                <div class="row push">
                    <div class="col-lg-4">
                        <p class="font-size-sm text-muted">
