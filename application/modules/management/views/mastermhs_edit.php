            ...
            <div class="block block-rounded">
                ...
                <div class="block-content block-content-full">
                    <div class="block-content font-size-sm">
                        <form action="<?= base_url('management/mastermhs/edit/proses'); ?>" method="post">
                                ...
                                <div class="col-lg-6">
                                    <div class="block-content font-size-sm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="js-maxlength form-control" name="nik" maxlength="16" required autocomplete="off" value="<?= $mahasiswa->nik; ?>" data-always-show="true" data-placement="bottom-right">
                                        </div>
                                        <div class="form-group">
                                            <label for="nim">NIM</label>
                                            <input type="text" class="js-maxlength form-control" maxlength="8" name="nim" required autocomplete="off" value="<?= $mahasiswa->nim; ?>" data-always-show="true" data-placement="bottom-right">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control js-select2" name="negara" style="width: 100%;" data-placeholder="Silakan pilih Kewarganegaraan..">
                                                <?php foreach ($negara as $data) : ?>
                                                    <?php $select = ($data->id_negara == $mahasiswa->kewarganegaraan ? 'selected="selected"' : '')  ?>
                                                    <option <?php echo $select ?> value="<?php echo enkrip($data->id_negara) ?>"><?php echo $data->nm_negara ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jk">
                                                ...
                                                <option value="<?= enkrip('L'); ?>" <?= $mahasiswa->jk == 0 ? 'selected="selected"' : ''; ?>>Laki - laki
                                                </option>
                                                <option value="<?= enkrip('P'); ?>" <?= $mahasiswa->jk == 1 ? 'selected="selected"' : ''; ?>>Perempuan
                                                </option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="agama">
                                                ...
                                                <?php foreach ($agama as $hasil) : ?>
                                                    <?php $select = ($hasil->id == $mahasiswa->agama ? 'selected="selected"' : '')  ?>
                                                    <option <?php echo $select ?> value="<?php echo enkrip($hasil->id) ?>"><?= $hasil->agama; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="block-content font-size-sm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ibu" required autocomplete="off" value="<?= $mahasiswa->nm_ibu_kandung; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="tahun">Tahun Masuk</label>
                                            <input type="number" class="js-maxlength form-control" name="tahun" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="4" min="2000" max="<?= $max_th; ?>" required autocomplete="off" value="<?= $mahasiswa->tahun_masuk; ?>" data-always-show="true" data-placement="bottom-right">
...
<script>
    ...
    $('li.nav-main-item').find('a[href*="<?= base_url('management/mastermhs/') . $prodi_ini ?>"]').addClass('active');
    $('li.nav-main-item').find('a[href*="<?= base_url('management/mastermhs/') . $prodi_ini ?>"]').parent().parent().parent().addClass('open');
    $('li.nav-main-item').find('a[href*="<?= base_url('management/mastermhs/') . $prodi_ini ?>"]').parent().parent().parent().parent().parent().addClass('open');
