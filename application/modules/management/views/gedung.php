        ...
        <div class="col-sm-12">
            <div class="block block-rounded">
                <div class="block-header bg-dark">
                    <h3 class="block-title text-white">List Gedung</h3>
                ...
                <div class="block-content block-content-full">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-vcenter start-at-25">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php if (is_array($gedung) || is_object($gedung)) : ?>
                                <?php foreach ($gedung as $hasil) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-warning edit_btn"
                                            ...
                                            data-id_gedung="<?= enkrip($hasil->id); ?>" data-nama="<?= $hasil->nama; ?>"
                                            title="Edit">
                                            <i class="fa fa-fw fa-pencil-alt"></i>
                                        </button>
                                        <button type="button"
                                            data-href="<?= base_url('management/gedung/delete/') . enkrip($hasil->id); ?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <form action="<?= base_url('management/gedung/add'); ?>" method="post">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <form action="<?= base_url('management/gedung/edit'); ?>" method="post">
                    <div class="block-content font-size-sm">
