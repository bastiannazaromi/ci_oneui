                                    ...
                                    <?php foreach ($data_khs as $hasil) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="display: inline-flex;">
                                                <button type="button" class="btn btn-sm btn-info" data-toggle="tooltip" title="Lihat KHS" onclick="location.href='<?= base_url('prodi/reportkhs/detail/') . enkrip($hasil->nim); ?>';">
...
<script>
    $('#by_tahun').change(function() {
        ...
        document.location.href = '<?php echo base_url('prodi/reportkhs/') ?>' + tahun;
    });
