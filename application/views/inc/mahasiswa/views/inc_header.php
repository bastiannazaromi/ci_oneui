            ...
            <div class="dropdown d-inline-block ml-2">
                <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    ($this->user->foto == 'default.jpg' || $this->user->foto == '') ?
                        base_url('upload/default.jpg') : base_url('upload/mhs/' . $this->user->foto)
                    ?>
                    " alt="<?= $this->user->nama_lengkap; ?>" style="width: 21px;">
                    <span class="d-none d-sm-inline-block ml-1"><?= $this->user->nama_lengkap; ?></span>
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                    <div class="p-3 text-center bg-primary-dark rounded-top">
                        ...
                        <p class="mt-2 mb-0 text-white font-w500"><?= $this->user->nama_lengkap; ?></p>
                        <p class="mb-0 text-white-50 font-size-sm"><?= $this->user->nim; ?></p>
                    </div>
                    <div class="p-2">
                        <a class="dropdown-item d-flex align-items-center justify-content-between" href="<?= base_url('mahasiswa/profil') ?>">
                            <span class="font-size-sm font-w500">Data Diri</span>
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between" href="<?= base_url('mahasiswa/keamanan') ?>">
